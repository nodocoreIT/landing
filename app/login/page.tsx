            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-[13px] font-semibold text-slate2 hover:text-ink cursor-pointer select-none bg-transparent border-none"
                >
